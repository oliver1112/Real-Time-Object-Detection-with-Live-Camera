...
int main(int argc, char** argv) try
{
    ...
    Net net = readNetFromCaffe("/root/librealsense/build/wrappers/opencv/dnn/MobileNetSSD_deploy.prototxt", 
                               "/root/librealsense/build/wrappers/opencv/dnn/MobileNetSSD_deploy.caffemodel");
